...
export function PrivacyPolicy() {
  ...
  const handleGoogleLinkPress = useCallback(async () => {
      ...
      <ScrollView style={{ width: "100%", paddingHorizontal: 32 }}>
        <View style={styles.paragraph}>
          ...
          <Text style={styles.text}>
            Leandro Vieira built the Modera Compra app as a Free app. This
            SERVICE is provided by Leandro Vieira at no cost and is intended for
            ...
            is accessible at Modera Compra unless otherwise defined in this
            Privacy Policy.
          </Text>
        </View>
        ...
        <View style={styles.paragraph}>
          ...
          <Text style={styles.text}>
            ...
            including but not limited to Grocery items bought. The information
          ...
          <TouchableOpacity onPress={handleGoogleLinkPress}>
        ...
        <View style={styles.paragraph}>
          ...
          <Text style={styles.text}>
            ...
            page. This policy is effective as of 2021-05-16
          </Text>
        </View>
        ...
        <View style={styles.paragraph}>
          ...
          <Text style={styles.text}>
            ...
            not hesitate to contact me at leandrofernandesvieira@gmail.com.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
